    ...
    <section className="py-16 md:py-24 bg-card">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatedSection className="text-center mb-12 md:mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">@LuxeGlow on Instagram</h2>
        ...
        >
          {images.map((image) => (
            <motion.div
              ...
              className="group relative aspect-square bg-gradient-to-br from-luxury-gold/20 to-luxury-rose/20 rounded-2xl overflow-hidden cursor-pointer shadow-md hover:shadow-xl transition-shadow"
            >
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-luxury-gold to-luxury-rose text-white font-semibold rounded-lg transition-all hover:-translate-y-1 hover:shadow-lg"
          >
            <Share2 size={20} /> Follow on Instagram
          </a>
        </motion.div>
      </div>
    </section>
