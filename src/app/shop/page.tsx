...
export default function Shop() {
  ...
  return (
    <div className="relative min-h-screen bg-background text-white selection:bg-gold/20 selection:text-gold">
      ...
      {/* Premium Filters Bar */}
      <section className="sticky top-[68px] z-30 border-y border-white/5 bg-background/80 backdrop-blur-xl md:top-[76px] py-4">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-3 self-end md:self-auto">
              ...
              <div className="relative">
                ...
                >
                  <option value="featured" className="bg-background text-white">
                    Featured
                  </option>
                  <option value="price-asc" className="bg-background text-white">
                    Price · Low to High
                  </option>
                  <option value="price-desc" className="bg-background text-white">
                    Price · High to Low
                  </option>
                  <option value="rating" className="bg-background text-white">
                    Rating
                  </option>
                </select>
                <div className="pointer-events-none absolute right-5 top-1/2 -translate-y-1/2 text-white/50 text-[8px]">
                  ▼
                </div>
              </div>
            </div>
