...
import { Leaf, Rabbit, ShieldCheck, Heart, Recycle } from "lucide-react";
...
export function RitualsWildSection() {
  return (
    <ClientOnly fallback={<RitualsWildFallback />}>
      {() => <RitualsWildAnimated />}
    </ClientOnly>
  );
}

function RitualsWildFallback() {
  return (
    <section className="section-cv relative overflow-hidden bg-[#0a1a0f] py-20 md:py-40">
      <div
        aria-hidden
