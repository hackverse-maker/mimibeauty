          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-3 self-end md:self-auto">
              ...
              <div className="relative">
                ...
                >
                  <option value="featured" className="bg-background text-white">Featured</option>
                  <option value="price-asc" className="bg-background text-white">Price · Low to High</option>
                  <option value="price-desc" className="bg-background text-white">Price · High to Low</option>
                  <option value="rating" className="bg-background text-white">Rating</option>
                </select>
